...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/prato/cadastroDePratos").hasRole("ADMIN")
		.antMatchers("/prato/ListarPratos").hasRole("ADMIN")
		.antMatchers("/pessoa/listar").permitAll()
		.antMatchers("/pessoa/salvar").permitAll()
		.antMatchers("/pessoa/index").permitAll()
		.antMatchers("/restaurante/formulario").permitAll()
		
		.antMatchers("/restaurante/administrador").hasRole("ADMIN")
		
		.antMatchers("/restaurante/index").permitAll()
		.antMatchers("/restaurante/inicio").permitAll()
		
		.antMatchers("/pedido/carrinho").permitAll()
		.anyRequest().authenticated()
		
		.and()
		.formLogin()
		.loginPage("/restaurante/logar").permitAll().defaultSuccessUrl("/restaurante/inicio")
		
		.and()
		.logout()
		.logoutSuccessUrl("/restaurante/logar?logout")
		.permitAll();
